...
FLASK_API_BASE_URL = "http://localhost:5000" # Adjust this if your Flask app is on a different host/port

# Define the endpoint for generating pitches
PITCH_GENERATION_ENDPOINT = f"{FLASK_API_BASE_URL}/smr/segmentation/pitches"

# Define the shutdown endpoint for the Flask app (if you implemented it)
FLASK_SHUTDOWN_ENDPOINT = f"{FLASK_API_BASE_URL}/shutdown"

# --- Streamlit UI ---
st.set_page_config(layout="centered", page_title="Flask API Interaction Demo")

st.title("TVS Personalized Service Remainder")
